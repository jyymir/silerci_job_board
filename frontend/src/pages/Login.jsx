    ...
    <div className="min-h-screen bg-[rgb(249,247,247)]">
      <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 mt-12">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
          <h2 class="mt-10 text-center text-2xl/9 font-bold tracking-tight text-[rgb(17,45,78)]">Sign in to your account</h2>
        </div>
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form action="#" method="POST" class="space-y-6">
            ...
            <div>
              <div class="flex items-center justify-between">
                ...
                <div class="text-sm">
                  <a href="#" class="font-semibold text-[rgb(25,86,155)] hover:text-indigo-300">Forgot password?</a>
                </div>
              </div>
              <div class="mt-2">
          ...
          <p class="mt-10 text-center text-sm/6 text-gray-400">
            Not a member?
            <a href="#" class="font-semibold text-[rgb(25,86,155)] hover:text-indigo-300">  Create an Account</a>
          </p>
        </div>
      </div>
    </div>
